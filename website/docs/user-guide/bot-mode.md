...
|---|---|---|
| `source_session_id` + `in_reply_to` (conversational) | **Bot Chat reply-home** — `message_agent` fires a background, notify-on-complete delivery keyed by the origin `task_id` | tag: `tools/bot_mode_dm.py:685` \| main: `tools/bot_mode_dm.py:641` |
